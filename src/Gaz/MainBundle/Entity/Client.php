...
class Client
{
    ...
    /**
     * @var
     * @ORM\Column(name="cash_info", type="integer", nullable=true, options={"default":0})
     * @Groups({"client"})
     */
    private $cashInfo;
    ...
    /**
     * @var
     * @ORM\Column(name="created", type="datetime", nullable=false, options={"default":"2016-01-01 00:00:00"})
     */
    private $created;
